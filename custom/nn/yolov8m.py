...
import math
from custom.nn.modules import (Conv, C2f, SPPF, Concat)
from .commons import dist2bbox, make_anchors
...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, ch=()):  # detection layer
        ...
        self.i = 1
        self.f = [15, 18, 21]
        self.t = 'custom.nn.yolov8m.Detect'
...
class Yolov8m(nn.Module):
    def __init__(self, ch=3):  # model, input channels, number of classes
        ...
        self.i = 0
        self.f = -1
        self.t = 'custom.nn.yolov8m.Yolov8m'
        self.conv1 = Conv(ch, 48, k=3, s=2)
        self.conv2 = Conv(48, 96, k=3, s=2)
        self.c2f_1 = C2f(96, 96, n=2, shortcut=True)
        self.conv3 = Conv(96, 192, k=3, s=2)
        self.c2f_2 = C2f(192, 192, n=4, shortcut=True)
        self.conv4 = Conv(192, 384, k=3, s=2)
        self.c2f_3 = C2f(384, 384, n=4, shortcut=True)
        self.conv5 = Conv(384, 576, k=3, s=2)
        self.c2f_4 = C2f(576, 576, n=2, shortcut=True)
        self.sppf = SPPF(576, 576, k=5)
        self.up1 = nn.Upsample(scale_factor=2, mode='nearest')
        self.cat1 = Concat(dimension=1)
        self.c2f_5 = C2f(960, 384, n=2)
        self.up2 = nn.Upsample(scale_factor=2, mode='nearest')
        self.cat2 = Concat(dimension=1)
        self.c2f_6 = C2f(576, 192, n=1)
        self.conv6 = Conv(192, 192, k=3, s=2)
        self.cat3 = Concat(dimension=1)
        self.c2f_7 = C2f(576, 384, n=1)
        self.conv7 = Conv(384, 384, k=3, s=2)
        self.cat4 = Concat(dimension=1)
        self.c2f_8 = C2f(960, 576, n=2)
        #self.detect = Detect(nc=4, ch=[192, 384, 576])
