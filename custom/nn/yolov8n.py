...
class Yolov8n(nn.Module):
    def __init__(self, ch=3):  # model, input channels, number of classes
        ...
        self.c2f_2 = C2f(64, 64, n=2, shortcut=True)
        self.conv4 = Conv(64, 128, k=3, s=2)
        self.c2f_3 = C2f(128, 128, n=2, shortcut=True)
        self.conv5 = Conv(128, 256, k=3, s=2)
        self.c2f_4 = C2f(256, 256, n=1, shortcut=True)
        self.sppf = SPPF(256, 256, k=5)
        self.up1 = nn.Upsample(scale_factor=2, mode='nearest')
        self.cat1 = Concat(dimension=1)
        self.c2f_5 = C2f(384, 128, n=1)
        self.up2 = nn.Upsample(scale_factor=2, mode='nearest')
        self.cat2 = Concat(dimension=1)
        self.c2f_6 = C2f(192, 64, n=1)
        self.conv6 = Conv(64, 64, k=3, s=2)
        self.cat3 = Concat(dimension=1)
        self.c2f_7 = C2f(192, 128, n=1)
