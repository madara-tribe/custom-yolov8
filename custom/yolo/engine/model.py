...
from custom import yolo  # noqa
from custom.nn.tasks import (DetectionModel, attempt_load_one_weight, guess_model_task, nn, yaml_model_load)
from custom.yolo.cfg import get_cfg
from custom.yolo.engine.exporter import Exporter
from custom.yolo.utils import (DEFAULT_CFG, DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, NUM_THREADS, RANK, ROOT,
                                    callbacks, is_git_dir, yaml_load)
from custom.yolo.utils.checks import check_file, check_imgsz, check_pip_update_available, check_yaml
from custom.yolo.utils.torch_utils import smart_inference_mode
...
TASK_MAP = {
    ...
    'detect': [
        DetectionModel, yolo.v8.DetectionTrainer, yolo.v8.DetectionValidator,
        yolo.v8.DetectionPredictor]}
    # 'segment': [
